...
$sql = "SELECT 
        ...
        WHERE 
            p.CategoryID = 3"; // Moved the WHERE clause after the JOIN
...
.link a{
    ...
    background-color: rgb(176, 47, 140);
    color: white;
    padding: 10px;
...
.section5{
    width: 100%;
    height: 100vh;
    background-image: url('img/bkn.jpg');
...
.section3 .back1 {
  background-image: url('img/jnl.jpg');
  background-repeat: no-repeat;
...
.section3 .back2 {
  background-image: url('img/chnl.jpg');
  background-repeat: no-repeat;
  background-size: cover; 
  animation: mvuph linear both;
    animation-timeline: view();
...
<div class="anim">
    <div class="sectionvis">
      ...
      <h1 class="block-effect" style="--td: 1.2s">
        <div class="block-reveal" style="--bc: #4040bf; --d: .1s">Nails</div>
    ...
    <?php include 'users_header.php'?>
        <div class="hero">
            ...
            <video autoplay loop muted plays-inline class="back-video"> <source src="nls.mp4" type="video/mp4">
            </video>
             <div class="content">
            <h1>Make your day shine <br> with your shiny nails
          </h1>
          <div class="link">
    ...
    <div class="section2" id="section2">
      ...
      <div class="img">
        <div class="card"><img src="img/nlsp.jpg" alt="" ></div>
        <div class="card"><img src="img/nlspp.jpg" alt="" ></div>
        <div class="card"><img src="img/nlsb.jpg" alt="" ></div>
        <div class="card"><img src="img/nlsr.jpg" alt="" ></div>
      </div>
        ...
        <div class="pup">
          <h4> <span>Pack Oriel Paris</span><br><br>
           Gift for you<br>bay this pack by a good price.<br> <br><b>120$</b><br><br>   </h4>
            ...
            <img src="img/soi.jpg" alt=""  width="350"><br>
            <br><a href="#section4">Bay Now</a> 
        </div>
        <div class="pup">
          <h4> <span>New</span><br><br>
           the most popular Now<br> with a good price <br> Summer Color<br><br> </h4>
           
            <img src="img/or.jpg" alt=""  width="370"><br>
